...
async def next_page(bot, query):
    ...
    btn.insert(2, [
        InlineKeyboardButton("Amrit ", callback_data="other"),
        InlineKeyboardButton("Kumar ", callback_data="fsub")
])
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        buttons = [[
                ...
                InlineKeyboardButton("Hᴇʟᴘ ⚙️", callback_data='Amrit'),
    ...
    # If the user isn't an admin, return
      ...
      buttons = [[
	      InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='Amrit'),
      ...
      await client.edit_message_media(
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('⋞ ʜᴏᴍᴇ', callback_data='Amrit'),
